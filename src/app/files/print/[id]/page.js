...
<body>
  ...
  if(file.file_type === 'POCRA' ){
   fileName = 'नानाजी देशमुख कृषि संजीवनी प्रकल्प';}
  else{
     fileName = 'प्रधानमंत्री कृषि सिंचाई योजने अंतर्गत केंद्र पुरस्कृत सिंचन योजना';
    } 
  return (
            ...
            <div className="text-right">
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="p-2 text-center text-xs mb-1" style={{minWidth: "220px"}}>
                  ...
                  <h2 className="text-lg font-bold"> {file.taluka || '__________'} उपविभागीय कृषि अधिकारी </h2>
                  <div className="flex-1  border-black px-2 py-1 font-bold text-xl">जिल्हा: {file.district || 'N/A'}</div>
                </div>
            ...
            <div className="text-right">
              <div className="p-2 text-center text-xs mb-1" style={{minWidth: "220px"}}>
                ...
                <div className=" p-2 text-xl border border-black border-t-0 font-bold">{file.farmer_id}</div>
                  ...
                  <h2 className="text-2xl m-2 font-bold">महाराष्ट्र शासन</h2>
                  <h2 className="text-xl font-bold">कृषि विभाग</h2>
                  <h2 className="text-lg font-bold">तालुका कृषि अधिकारी </h2>
          ...
          <div className="mt-1">
            <div className="p-1 text-xs leading-relaxed">
              ...
              <ol className="list-decimal ml-2 space-y-2">
                ...
                <li>प्रधानमंत्री कृषि सिंचन योजनेतून सूक्ष्म सिंचन घटकाचा लाभ मिळण्यासाठी मी सादर केलेली कागदपत्रे खरी आहेत. </li>
              </ol>
        ...
        >
          ...
          <div className="mt-4 text-xs leading-relaxed">
            ...
            <ol className="list-decimal ml-4 mt-3 space-y-1">
              <li>मी उत्पादक कंपनीच्या वतीने आम्ही घेतो की पुरवलेल्या ठिबक तुषार सिंचन संच यातील सर्व साहित्य कृषि आयुक्त यांनी ठरवून दिलेल्या निकषानुसार योग्य दर्जाचे चा आहे.</li>
              ...
              <li>संच बसवलेले साहित्य बी.आय.एस मार्कचे व माननीय आयुक्त कृषि यांच्याकडे माझ्या कंपनीने दिलेल्या मेकचे आहे.</li>
            ...
            <p className="mt-1">
              वरील प्रमाणे उत्पादक व लाभार्थी शेतकऱ्यांमध्ये जवाबदारी पार पडताना वाद निर्माण झाल्यास माननीय आयुक्त कृषि यांचा निर्णय अंतिम व संबंधितावर बंधनकारक राहील. माननीय आयुक्त यांचे निर्णयाशी समाधान न झाल्यास दोन्ही पक्षाला तक्रारीचे निराकरण करण्याकरता ग्राहक मंच किंवा इतर न्याय कार्यप्रणाली वापरण्याचा अधिकार राहील.
            </p>
